...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Registration Confirmed - {{ config('app.name', 'RafEvent') }}</title>
                    ...
                    <div class="text-center space-y-6">
                        <div class="space-y-4">
                            <p class="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
                                ...
                                <span class="font-semibold text-green-600 dark:text-green-400">Your registration is now complete.</span>
                            </p>
                        </div>
                    </div>
                </div>
